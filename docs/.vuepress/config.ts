...
export default defineUserConfig({
  ...
  theme: plumeTheme({
    ...
    hostname: 'https://www.mn.edu.kg',
    /* 文档仓库配置，用于 editLink */
    docsRepo: 'mcenahle/plume-edu-site',
    docsDir: 'docs',
    docsBranch: 'main',
      ...
      '/about/': [
        {
          text: '关于',
          items: [
            { text: '本网站', link: '/about/', icon: 'carbon:home' },
            { text: '邮箱', link: '/about/mail.html', icon: 'material-symbols:mail-outline' },
          ]
        }
      ],
      '/nzzj/': [
    ...
    markdown: {
      ...
      mark: 'lazy',       // 启用在滚动到可视区域后再播放马克笔动画
      bilibili: true,     // 启用嵌入 bilibili视频 语法 @[bilibili](bid)
      youtube: true,      // 启用嵌入 youtube视频 语法 @[youtube](video_id)
      // artPlayer: true,    // 启用嵌入 artPlayer 本地视频 语法 @[artPlayer](url)
      audioReader: true,  // 启用嵌入音频朗读功能 语法 @[audioReader](url)
      icon: { provider: 'iconify', prefix: 'carbon', },        // 启用内置图标语法  ::icon-name::
      // 启用表格增强容器语法 ::: table
      table: {
